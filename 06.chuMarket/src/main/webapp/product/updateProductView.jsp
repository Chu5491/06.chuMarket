...
{
	window.open("/listSale.do?prodNo="+prodNo,"popWin", "left=300,top=200,width=900,height=500,marginwidth=0,marginheight=0,scrollbars=no,scrolling=no,menubar=no,resizable=no");	
}
</script>
